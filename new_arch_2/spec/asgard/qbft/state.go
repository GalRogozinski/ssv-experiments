...
// uniqueSignerForRound returns true if <signer, round, message type> unique
func uniqueSignerForRound(state *types.QBFT, signedMessage *types.QBFTSignedMessage) bool {
	for _, msg := range state.Messages {
